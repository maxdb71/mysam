...
export default class {
    ...
    static isUserClockedIn(context) {
        ...
        if (libThis.isCICOEnabled(context)) {
            return context.read('/SAPAssetManager/Services/AssetManager.service', 'UserTimeEntries', [], '$orderby=PreferenceValue desc&$top=1&$expand=WOHeader_Nav,WOOperation_Nav,WOHeader_Nav/OrderMobileStatus_Nav,WOOperation_Nav/OperationMobileStatus_Nav').then(function(results) {
